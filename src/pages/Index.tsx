...
import { Activity, CheckCircle2, PackageOpen, XCircle, AlertCircle, Loader2 } from 'lucide-react'
...
export default function Index() {
  const { filteredTests, isLoadingMaterials, materialsError } = useDashboardData()
    ...
    <div className="space-y-6 pb-8">
      {materialsError && (
        <Alert variant="destructive">
          ...
          <AlertDescription>
            Não foi possível carregar os dados de materiais do Oracle: {materialsError}
          </AlertDescription>
        </Alert>
      )}
